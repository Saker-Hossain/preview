        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <form action="{{route('updateproduct')}}" method="POST">
                ...
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label" for="basic-default-name">Product Cost</label>
                    <div class="col-sm-10">
                    <input type="number" class="form-control" id="cost" name="cost" value="{{$productinfo->cost}}" />
                    </div>
                </div>
                <div class="row mb-3">
