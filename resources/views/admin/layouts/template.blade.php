...
>
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('dashboard/assets/vendor/css/theme-default.css')}}vendor/css/theme-default.css" class="template-customizer-theme-css" />
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Preview</span>
            </a>
          ...
          <ul class="menu-inner py-1">
                ...
                <li class="menu-item ">
                    <a href="index.html" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-home-circle"></i>
                        <div data-i18n="Analytics">Cancle Orders</div>
                    </a>
                </li>
            </ul>
            <!-- Components -->
