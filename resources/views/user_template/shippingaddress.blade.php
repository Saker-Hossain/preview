                    ...
                    <form action="{{route('addshppingaddress')}}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="text" class="form-control mb-3" id="street_address" value="" name="street_address">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="number" class="form-control" id="phone_number" min="0" value="" name="phone_number">
                            </div>
                            <div class="col-12 mb-4">
                                <label for="email_address">Email Address <span>*</span></label>
                                <input type="email" class="form-control" id="email_address" value="" name="email_address">
                            </div>
                        ...
                        <input type="submit" class="btn essence-btn" value="Next">
                    </form>
                </div>
            </div>
