    ...
    <header class="header_area">
        <div class="classy-nav-container breakpoint-off d-flex align-items-center justify-content-between">
            ...
            <div class="header-meta d-flex clearfix justify-content-end">
                ...
                <!-- Cart Area -->
                <div class="cart-area">
                    <a href="#" id="essenceCartBtn"><img src="{{ asset('home/img/core-img/bag.svg') }}" alt=""> <span>3</span></a>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="popular-products-slides owl-carousel">
                        ...
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="{{ asset('home/img/product-img/product-2.jpg') }}" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="{{ asset('home/img/product-img/product-3.jpg') }}" alt="">
                                <!-- Favourite -->
                                <div class="product-favourite">
                                    <a href="#" class="favme fa fa-heart"></a>
                                </div>
                        ...
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="{{ asset('home/img/product-img/product-3.jpg') }}" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="{{ asset('home/img/product-img/product-4.jpg') }}" alt="">
                        ...
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="{{ asset('home/img/product-img/product-4.jpg') }}" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="{{ asset('home/img/product-img/product-5.jpg') }}" alt="">
